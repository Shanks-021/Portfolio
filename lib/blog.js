 ...
 *
 * Drafts 404 in production but stay readable via their direct URL in `next dev`,
 * so you can preview a post before publishing it. Without this, excluding drafts
 * from generateStaticParams is not enough - Next still renders unknown slugs on
 * demand, which would serve the draft to anyone with the link.
 */
